...
<div class="relative z-10 pt-10 pb-10 px-4 flex-1 overflow-y-auto">
    <div class="text-center">
        ...
        <p class="mt-4 text-lg font-medium text-gray-800">
            Yuk, belajar sambil bermain dan mengenal dunia TK Bersama!
        </p>
    </div>
    ...
    <div class="mt-18 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
        ...
        <a href="/tk/matematika/pilih"
            ...
            <h2 class="text-2xl font-bold text-gray-900">Matematika Dasar</h2>
        ...
        <a href="/warna"
            ...
            <h2 class="text-2xl font-bold text-gray-900">Agama & Moral</h2>
