...
<body class="bg-game min-h-screen flex flex-col font-sans relative overflow-x-hidden">
    ...
    <div class="flex-grow flex items-center justify-center px-4 pt-20 pb-10">
        ...
        <div class="relative w-full max-w-lg bg-[#FFF9E3] rounded-[40px] border-[10px] border-[#D28E43] shadow-2xl p-6 text-center">
            ...
            <div class="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-green-600 text-white px-8 py-2 rounded-xl shadow-lg font-bold text-xl uppercase tracking-wider z-20">
                Perkalian
            </div>
    ...
    <script>
        ...
        function loadQuestion() {
            ...
            // Logika Perkalian: Angka 1-5 saja biar tidak terlalu susah
            ...
            // Generate pilihan jawaban yang masuk akal
        ...
        function showFinish() {
            ...
            fetch('/leaderboard/save', {
                ...
                body: JSON.stringify({ quiz_type: "tk_perkalian", score: score })
