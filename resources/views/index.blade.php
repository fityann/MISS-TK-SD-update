  ...
  {{-- Konten utama --}}
  <div class="relative z-10 pt-24 pb-10 px-4 flex-1 overflow-y-auto">
    ...
    <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
      ...
      <a href="/angka"
        ...
        <img src="{{ asset('assets/img/btn_numbers.png') }}" alt="Angka" class="mx-auto w-20 mb-3 animate-wiggle">
